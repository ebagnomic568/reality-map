...
3. Choose the folder that contains the code you want to see.
4. Wait for the scan to finish. A progress bar shows you how much remains.
5. Once complete, your architecture appears on the screen as a series of connected boxes.
